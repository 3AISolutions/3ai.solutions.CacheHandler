...
namespace _3ai.solutions.CacheHandler
{
    public class CacheHandlerService
    {
        ...
        public class CacheItem
        {
            ...
            //    }
            //}
            //public Func<eCatalogContext, int, object> Func { get; set; }
            //public Func<eCatalogContext, int, Task<object>> FuncAsync { get; set; }
        }
        ...
        //            //using var context = scope.ServiceProvider.GetRequiredService<eCatalogContext>();
        //            //object itms;
        //            //if (cacheItem.Func != null)
        //            //    itms = cacheItem.Func(context, cacheItem.PortalId);
        //            //else
        //            //    itms = await cacheItem.FuncAsync(context, cacheItem.PortalId);
        //            await Clear(key);
        ...
        //                    {
        //                        AddCacheItemToReset(key.ToString());
        ...
        //public TItem GetOrCreate<TItem>(string key, Func<eCatalogContext, int, object> func,
        //                                    CacheExpiration cacheExpiration = CacheExpiration.Never,
        //                                    eCatalogContext context = null,
        //                                    int portalId = 0)
        //{
        ...
        //                break;
        //        }
        //        //if (!CacheItems.Keys.Contains(key))
        //        //    CacheItems.TryAdd(key, new CacheItem { Key = key, Func = func, CacheExpiration = cacheExpiration });
        //        return (TItem)func(context, portalId);
        //    });
        //}

        //public Task<TItem> GetOrCreateAsync<TItem>(string key, Func<eCatalogContext, int, Task<object>> func,
        //                                            CacheExpiration cacheExpiration = CacheExpiration.Never,
        //                                            eCatalogContext context = null,
        //                                            int portalId = 0)
        //{
        ...
        //        return (TItem)await func(context, portalId);
        //    });
        //}
